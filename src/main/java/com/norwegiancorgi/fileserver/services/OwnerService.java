...
public class OwnerService {
    ...
    public Owner getOwnerByEmail(String email) {
        return ownerRepository.findOwnerByEmail(email).get();
    }

    public void init(Long id) throws Exception {
        final String currentFolder = rootLocation + id.toString();
        try {
    ...
    public void createOwner(String name, String email, String password) throws Exception {
        try {
            final Owner owner = new Owner(name, email, password);
        ...
        init(ownerRepository.findOwnerByEmail(email).get().getId());
    }

    public void updatePassword(Long id, String oldPassword, String newPassword) throws Exception {
        final Owner owner = ownerRepository.getById(id);
